...
use systems::game::systems::{setup_game, move_player, apply_gravity, apply_physics, cleanup_game};
...
fn main() {
    App::new()
        ...
        .add_systems(Update, (move_player, apply_gravity, apply_physics).run_if(in_state(GameState::InGame)))
